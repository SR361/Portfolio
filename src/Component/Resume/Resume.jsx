            ...
            <div className="rn-resume-area rn-section-gap section-separator" id="resume">
                <div className="container">
                    ...
                    <div className="row mt--45">
                        <div className="col-lg-12">
                            <ul className="rn-nav-list nav nav-tabs" id="myTabs" role="tablist" style={{borderBottom: "none"}}>
                                <li className="nav-item">
                                    <a className="nav-link active" id="designskill-tab" data-bs-toggle="tab" href="#designskill" role="tab" aria-controls="designskill" aria-selected="true">Design Skill</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" id="professional-tab" data-bs-toggle="tab" href="#professional" role="tab" aria-controls="professional" aria-selected="false">Development Skills</a>
                                </li>
                                <li className="nav-item">
                            ...
                            <div className="rn-nav-content tab-content" id="myTabContents">
                                <div className="tab-pane show active fade single-tab-area" id="designskill" role="tabpanel" aria-labelledby="designskill-tab">
                                                ...
                                                <div className="progress-wrapper">
                                                    <div className="content">
                                                        ...
                                                        <div className="progress-charts">
                                                            ...
                                                            <div className="progress">
                                                                <div className="progress-bar wow fadeInLeft" data-wow-duration="0.7s" data-wow-delay=".5s" role="progressbar" style={{width: "70%"}} aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"><span
                                                        ...
                                                        <div className="progress-charts">
                                                            ...
                                                            <div className="progress">
                                                                <div className="progress-bar wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay=".6s" role="progressbar" style={{width: "85%"}} aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"><span
                                                ...
                                                <div className="progress-wrapper">
                                                    <div className="content">
                                                        <div className="progress-charts">
                                                            ...
                                                            <div className="progress">
                                                                <div className="progress-bar wow fadeInLeft" data-wow-duration="0.9s" data-wow-delay=".7s" role="progressbar" style={{width: "60%"}} aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"><span
                                                        ...
                                                        <div className="progress-charts">
                                                            <h6 className="heading heading-h6">AJAX</h6>
                                                            <div className="progress">
                                                                <div className="progress-bar wow fadeInLeft" data-wow-duration="0.9s" data-wow-delay=".7s" role="progressbar" style={{width: "90%"}} aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"><span
                                                                className="percent-label">90%</span></div>
                                                            </div>
                                                        ...
                                                        <div className="progress-charts">
                                                            ...
                                                            <div className="progress">
                                                                <div className="progress-bar wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay=".3s" role="progressbar" style={{width: "40%"}} aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"><span
                                                                className="percent-label">40%</span></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div className="tab-pane show active fade single-tab-area" id="professional" role="tabpanel" aria-labelledby="professional-tab">
                                    <div className="personal-experience-inner mt--40">
                                        <div className="row row--40">
                                            <div className="col-lg-6 col-md-6 col-12">
                                                <div className="progress-wrapper">
                                                    <div className="content">                                                        
                                                        <div className="progress-charts">
                                                            ...
                                                            <div className="progress">
                                                                <div className="progress-bar wow fadeInLeft" data-wow-duration="0.6s" data-wow-delay=".4s" role="progressbar" style={{width: "60%"}} aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"><span
                                                                className="percent-label">60%</span></div>
                                                            </div>
                                                        </div>
                                                        <div className="progress-charts">
                                                        ...
                                                        <div className="progress-charts">
                                                            ...
                                                            <div className="progress">
                                                                <div className="progress-bar wow fadeInLeft" data-wow-duration="0.9s" data-wow-delay=".7s" role="progressbar" style={{width: "50%"}} aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"><span
                                                                className="percent-label">50%</span></div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="resume-single-list">
                                                            <div className="inner">
                                                                ...
                                                                <p className="description">
                                                                    Employed as a React Front Developer at Evion Technologies,, contributing to the creation and enhancement of web applications. Focused on leveraging React and JavaScript to build dynamic user interfaces that deliver seamless user experiences. Collaborated with design and backend teams to ensure effecti
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
